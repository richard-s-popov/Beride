...
set _DeploySetParametersFile=%RootPath%TransportSystem.Area.Web.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%TransportSystem.Area.Web.zip" (
echo "%RootPath%TransportSystem.Area.Web.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%TransportSystem.Area.Web.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%TransportSystem.Area.Web.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%TransportSystem.Area.Web.deploy-readme.txt" (
...
start notepad "%RootPath%TransportSystem.Area.Web.deploy-readme.txt"
)
echo =========================================================
goto :eof
